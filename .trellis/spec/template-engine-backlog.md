...
| Layout | `layout.md` | `k-placeholder`、双栏 |
| Page | `page.md` | 完整页 / `<layout>` + `<placeholder>` |
| View | `view.md` | `<view id>`、拆分原则 |
| Script | `js.md` | 路由 JS、importmap |
| Style | `css.md` | 路由 CSS、Tailwind |
| 模板绑定 | `template-binding-syntax.md` | `env="server"`、`k-*` 指令 |
| k-data 占位 | `k-data.md` | 待写，替代 k-query |
